...
\033[1;95m☞ Page    : https://www.facebook.com/Black-Anonymous-Warrior--103727458389462/
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Hafizvau Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Hafizvau WhatsApp ')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num 01936321704✓')
	    psb('WellCome To hafizvau')
	    psb('Congratulations Hafizvau Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ baw✓')
	    psb('🔓Password ☆ hafizvau✓')
	    psb('Subscrib My Youtube Chenal Hafizvau✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/baw && python2 Bawhafizvau.py')
	elif bm =='3':
...
def pb():
	...
	print
	raw_input(R + 'Back')
	os.system('python2 bawhafizvau.py')
